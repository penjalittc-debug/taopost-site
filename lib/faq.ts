...
export const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer: 'Автодоставка — 450 ₽/кг, авиадоставка — от 2 700 ₽/кг. Точная стоимость зависит от веса, объёма и категории товара. Стоимость считается по большему из фактического и объёмного веса.',
  },
  {
