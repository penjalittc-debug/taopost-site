      ...
      <div className="abt__container">
        ...
        <div className="abt__head">
          ...
          <p className="abt__lede">
            ...
            Команда работает с 2019 года; для полностью легальной работы в КНР
            в 2025 году зарегистрировано юридическое лицо
            (广州亚世名进出口有限公司) с собственной бизнес-лицензией.
            Свой склад в Гуанчжоу и менеджеры на русском и китайском.
          </p>
        </div>
        ...
        <div className="abt__grid">
          <div className="abt__textBlock">
            ...
            <p className="abt__text">
              Работаем с частными клиентами по всей России. Все операции в Китае
              ведём через расчётный счёт нашей компании — никаких серых схем
              и переводов на физлица.
            </p>
          </div>
        </div>
