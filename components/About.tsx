      ...
      <div className="abt__container">
        ...
        <div className="abt__head">
          ...
          <p className="abt__lede">
            Мы карго-компания по доставке товаров из Китая в Россию. Команда
            работает с&nbsp;2019&nbsp;года, а для полностью легальной работы в&nbsp;КНР
            в&nbsp;2025 зарегистрировано юридическое лицо&nbsp;— 广州亚世名进出口有限公司
            (Guangzhou Yashiming Import &amp; Export Co., Ltd.). Собственный
            склад в Гуанчжоу, команда на русском и китайском.
          </p>
        </div>
        ...
        <div className="abt__grid">
          ...
          <div className="abt__textBlock">
            ...
            <ul className="abt__list">
              ...
              <li>
                <strong>Прозрачные цены.</strong> Тариф 450 ₽/кг (авто) — фиксированный.
                Комиссия за выкуп — открытые 5% (мин. 1 000 ₽).
              </li>
              <li>
