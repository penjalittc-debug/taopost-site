...
const ROWS: Row[] = [
  ...
  { topic: 'Страховка груза', us: 'По желанию: ~2% от стоимости (дороже 10 000 ₽/шт — 10%), компенсация по факту за 14 дней', them: 'Без гарантий: пропала посылка — твои проблемы' },
