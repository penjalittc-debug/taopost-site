          ...
          <div>
            ...
            <div className="ftr__contacts">
              ...
              <div className="ftr__warehouse">
                ...
                {/* 01.09.2026: здесь стоял адрес другого объекта — 水口大道西3号,
                    志洋国际货运. Клиент, сверявший футер с личным кабинетом, видел
                    два разных склада. Владелец подтвердил: верный тот, что в
                    приложении. Единый источник — src/lib/warehouse.ts в репозитории
                    app.taopost.ru, строка отсюда должна совпадать с ним символ
                    в символ: клиент копирует её продавцу. */}
                <a
                  href="https://maps.google.com/?q=广东省佛山市南海区里水镇白塔村工业大道36号"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="ftr__warehouseAddr"
                >
                  广东省佛山南海区里水镇白塔村工业大道36号前排一楼 阿里<br />
