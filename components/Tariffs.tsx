    ...
    <section id="tariffs" className="tp-section">
      ...
      <div className="tp-container">
        ...
        <div className="tar__notice">
          ...
          Минимального веса отправки нет: минимальный счёт за доставку — 450 ₽ (1 кг). С Poizon выкупаем от 1 пары кроссовок. Стоимость рассчитывается по большему из фактического и объёмного веса.
