...
const SERVICES: Service[] = [
  { Icon: Shield, name: 'Страховка груза', price: 'По желанию', desc: 'Не обязательная. Около 2% от стоимости товара, для товара дороже 10 000 ₽ за единицу — 10%. Покрывает сам товар, но не внешнюю коробку', tone: 'ink' },
  { Icon: Package, name: 'Упаковка', price: 'Включена', desc: 'Коробка, наполнитель и работа склада входят в тариф за килограмм — отдельной платы нет', tone: 'green' },
  { Icon: ShoppingCart, name: 'Выкуп товара', price: '10%', desc: 'Выкупаем с любого китайского маркетплейса без китайской карты и аккаунта. Минимум 500 ₽; для опта с 1688 — от 3%', tone: 'coral' },
    ...
    <section id="tariffs" className="tp-section">
      ...
      <div className="tp-container">
          ...
          <div className="tp-card tar__block">
            <div className="tar__head">
              ...
              <div>
                ...
                <p className="tar__sub">Выгодная цена для регулярных отправок</p>
              </div>
            </div>
        ...
        <div className="tar__notice">
          ...
          Минимального веса отправки нет: минимальный счёт за доставку — 450 ₽ (1 кг). С Poizon выкупаем от 1 пары кроссовок. Объёмный вес не считаем — платите за реальный вес на весах.
