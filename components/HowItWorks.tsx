...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    tile: 'ink',
    description: 'Вы полностью контролируете товары в личном кабинете на сайте. Объединяйте несколько заказов в один ящик или разделяйте их для отправки в разные пункты.',
    options: null,
  },
  {
    number: '04',
  ...
  },
  {
    ...
    tile: 'green',
    description: 'Когда груз прибудет в Россию — вы получите уведомление. Оформите доставку до конечного адреса прямо в личном кабинете.',
    options: null,
  },
];
