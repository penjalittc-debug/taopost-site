...
const ITEMS: Item[] = [
  ...
  },
  {
    ...
    a: '10% от суммы заказа (мин. 500 ₽). С 1688 (опт) — от 3% (мин. 1 500 ₽).',
  },
  {
  ...
  },
  {
    ...
    a: 'ИП Гасанова А. Р., ИНН 772300526747 — счёт в РФ, договор-оферта, чек.',
  },
  {
    q: 'Что со страховкой груза?',
    a: 'По желанию: около 2% от стоимости товара, дороже 10 000 ₽ за единицу — 10%. Возмещение по факту в течение 14 дней, сумма — заявленная стоимость. Покрывает товар, но не внешнюю коробку — говорим это сразу, а не после пропажи.',
  },
];
