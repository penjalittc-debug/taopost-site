...
export const metadata: Metadata = {
  title: 'Гарантии TaoPost — проверка качества, страховка, возврат при браке',
  description: 'Конкретные гарантии TaoPost: фото каждой посылки на складе, страховка груза по желанию, возврат при браке, отслеживание на всём маршруте. Что покрывается и что нет.',
  alternates: { canonical: 'https://taopost.ru/garantii' },
  openGraph: {
    title: 'Гарантии TaoPost — что мы обещаем и за что отвечаем',
    description: 'Проверка качества, фото со склада, страховка по желанию, возврат при браке. Конкретные обязательства.',
...
const GUARANTEES = [
  {
    ...
    color: '#005C43',
    bg: '#e8f7f3',
    title: 'Страховка груза — по желанию',
    text: 'Не обязательная: оформляем, только если вы попросили. Покрывает потерю и физические повреждения САМОГО ТОВАРА на всём маршруте — от приёмки на складе в Гуанчжоу до выдачи в России. Внешняя коробка и фирменная упаковка не покрываются.',
    detail: 'Стоимость — около 2% от цены товара, для товара дороже 10 000 ₽ за единицу — 10%. Возмещение по факту, в течение 14 рабочих дней после подтверждения страхового случая. Размер компенсации — заявленная стоимость товара по инвойсу.',
  },
  {
    Icon: Camera,
    color: '#FF5A47',
  ...
  },
  {
    ...
    detail: 'Услуги, оплачиваемые отдельно (выкуп 10%, для опта с 1688 — от 3%; фото сверх бесплатных пяти), всегда обсуждаются заранее. Упаковка в их числе НЕ значится — она входит в тариф за килограмм.',
  },
];
