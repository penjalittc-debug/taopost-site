        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{ background: 'white', borderRadius: '24px', padding: '48px', border: '1px solid #F3F4F6', lineHeight: 1.8 }}>
            ...
            <Section title="1. Общие положения">
              ...
              <p>Услуги по Сервису оказывает компания <strong>广州亚世名进出口有限公司</strong> (Guangzhou Yashiming Import &amp; Export Co., Ltd.), зарегистрированная в Китайской Народной Республике (регистрационный код 91440100MAEGJX2C1Y) — далее «Исполнитель».</p>
