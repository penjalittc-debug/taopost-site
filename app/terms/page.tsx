        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{ background: 'white', borderRadius: '24px', padding: '48px', border: '1px solid #F3F4F6', lineHeight: 1.8 }}>
            ...
            <Section title="1. Общие положения">
              ...
              <p><strong>Исполнитель</strong> — ООО «АЗИЗОВ ГРУПП» (ИНН 9721235929, ОГРН 1247700473921), выступающий представителем и партнёром компании 广州亚世名进出口有限公司 (Guangzhou Yashiming Import &amp; Export Co., Ltd., регистрационный код КНР 91440100MAEGJX2C1Y), которая осуществляет физический выкуп товаров и их приёмку на складе в КНР.</p>
              <p>Условия и порядок оказания возмездных услуг оформлены отдельным <Link href="/oferta" style={{ color: '#005C43' }}>публичным договором-офертой</Link>. Настоящее Соглашение регулирует правила пользования сайтом taopost.ru.</p>
            ...
            <Section title="10. Контакты">
              ...
              <ul>
                ...
                <li>Email (обращения и жалобы): <a href="mailto:help@taopost.ru" style={{ color: '#005C43' }}>help@taopost.ru</a></li>
            ...
            <Section title="12. Реквизиты Исполнителя">
              ...
              <p>Полные условия оказания возмездных услуг — в <Link href="/oferta" style={{ color: '#005C43' }}>публичном договоре-оферте</Link>. Реестровая информация о партнёре в КНР доступна на сайте <a href="https://www.gsxt.gov.cn/" target="_blank" rel="noopener noreferrer" style={{ color: '#005C43' }}>gsxt.gov.cn</a>.</p>
            </Section>
