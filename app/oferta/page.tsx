...
export const metadata = {
  ...
  description: 'Публичный договор-оферта на оказание услуг по выкупу и доставке товаров из Китая в Россию. ИП Гасанова А. Р., ИНН 772300526747.',
...
export default function OfertaPage() {
  return (
    <LegalLayout title="Публичный договор-оферта" date="Действует с 1 августа 2026 года" wide>
      <Section title="1. Общие положения">
        ...
        <p>
          <strong>Исполнитель:</strong> ИП Гасанова А. Р. (ИНН 772300526747, ОГРНИП 324774600431591),
          выступающая представителем и партнёром компании 广州亚世名进出口有限公司
        ...
        <p>
          ...
          оформление заявки на сайте taopost.ru, направление сообщения в Telegram-чат
          @Taopostchat_official или оплата счёта, выставленного Исполнителем.
        </p>
      </Section>
      ...
      <Section title="3. Стоимость услуг и порядок расчётов">
        ...
        <ul>
          ...
          <li>международную доставку по действующему тарифу (автомобильная — 450 ₽/кг, авиа — от 2 700 ₽/кг);</li>
        ...
        <p>Актуальные тарифы публикуются на странице <Link href="/tarify">taopost.ru/tarify</Link>. Оплата производится в рублях РФ на реквизиты Исполнителя после согласования сметы. Комиссия за выкуп составляет 5 % от стоимости товаров (минимум 1 000 ₽); для оптовых закупок с 1688 — от 3 % (мин. 1 500 ₽).</p>
      </Section>
      ...
      <Section title="5. Права и обязанности сторон">
        ...
        <ul>
          ...
          <li>сохранять конфиденциальность персональных данных Заказчика в соответствии с
            <Link href="/privacy"> Политикой конфиденциальности</Link>;</li>
      ...
      <Section title="8. Персональные данные">
        <p>Оператор персональных данных — ИП Гасанова А. Р. Обработка производится в соответствии с
          Федеральным законом № 152-ФЗ и
          <Link href="/privacy"> Политикой конфиденциальности</Link>, размещённой
