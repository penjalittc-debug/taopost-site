  ...
  return (
    <LegalLayout title="Публичный договор-оферта" date="Действует с 1 августа 2026 года" wide>
      ...
      <Section title="3. Стоимость услуг и порядок расчётов">
        ...
        <p>Актуальные тарифы публикуются на странице <Link href="/tarify">taopost.ru/tarify</Link>. Оплата производится в рублях РФ на реквизиты Исполнителя после согласования сметы. Комиссия за выкуп для одиночных заказов с Taobao, Poizon, Pinduoduo, Tmall не взимается; для оптовых закупок с 1688 применяется комиссия от 3 % (мин. 1 500 ₽).</p>
      </Section>
