...
export async function generateMetadata({ params }: { params: Promise<Params> }): Promise<Metadata> {
  ...
  const description = firstSentence
    ? `${firstSentence} Срок — ${city.deliveryDays} (авто) или ${city.deliveryDaysAvia} (авиа). Выкуп с Taobao, Poizon, 1688 — комиссия 10% (мин. 500 ₽).`
...
export default async function CityGuidePage({ params }: { params: Promise<Params> }) {
  ...
  const cityFaq = [
    ...
    },
    {
      ...
      a: `Авто-тариф — 450 ₽/кг, минимальный счёт 450 ₽ (1 кг). Авиа — от 2 700 ₽/кг. Минимального веса нет. С Poizon выкупаем от 1 пары кроссовок. Стоимость доставки до пункта выдачи ${city.nameLocative} рассчитывается отдельно (СДЭК/Boxberry).`,
    },
    {
    ...
    },
    {
      ...
      a: 'Комиссия за выкуп — 10% от стоимости товаров, минимум 500 ₽. Плюс вы платите стоимость товара и доставку до России.',
    },
    {
          ...
          <div className={s.heroInner}>
            ...
            <div className={s.statsGrid}>
              ...
              <div className={s.statCard}>
                ...
                <div className={s.statLabel}>Комиссия выкупа (мин. 500 ₽)</div>
              </div>
            </div>
          ...
          <div className={s.stepsInner}>
            ...
            <div className={s.stepsGrid}>
              {[
                ...
                { n: 2, t: 'Выкуп', d: 'Мы выкупаем товар у продавца в Китае — комиссия 10% (мин. 500 ₽)' },
