  ...
  return (
    <LegalLayout title="Политика конфиденциальности" date="Последнее обновление: апрель 2026 года">
      <Section title="1. Общие положения">
        ...
        <p><strong>Оператор персональных данных:</strong> Индивидуальный предприниматель Гасанова Айтадж Рагуф Кызы (сокращённо — ИП Гасанова А. Р.), ИНН 772300526747, ОГРНИП 324774600431591, адрес для корреспонденции: 109428, г. Москва, ул. 2-я Институтская, д. 6, стр. 15.</p>
      ...
      <Section title="7. Права пользователя">
        ...
        <p>Для реализации прав обратитесь к нам по адресу: <a href="mailto:support@taopost.ru">support@taopost.ru</a></p>
      </Section>
