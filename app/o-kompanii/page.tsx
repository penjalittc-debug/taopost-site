...
const TIMELINE = [
  ...
  { year: '2025', title: 'Регистрация юр.лица КНР', text: 'Оформили официальную бизнес-лицензию (营业执照) в Гуанчжоу — все операции идут через китайское юр.лицо. В РФ работает представитель ИП Гасанова А. Р.' },
