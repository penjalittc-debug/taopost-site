...
export const metadata: Metadata = {
  ...
  description: "Карго доставка из Китая в Россию. Выкупаем и доставляем одежду, обувь, электронику с Taobao, Poizon, Pinduoduo, 1688, Goofish. Авто от 350 ₽/кг, авиа от 2 700 ₽/кг. Москва, СПб, Новосибирск, Екатеринбург, Казань и все города РФ.",
  keywords: [
    "доставка из Китая",
