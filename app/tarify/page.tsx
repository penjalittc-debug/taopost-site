...
const TARIFFS_FAQ = [
  {
    ...
    a: 'Базовая стоимость — это цена за килограмм по выбранному маршруту (авто или авиа). Также учитывается объёмный вес для лёгких/громоздких товаров (если объёмный вес больше фактического — считаем по нему). Дополнительно: страховка груза 2% от стоимости товара, выкуп 10% (для опта с 1688 — от 3%). Упаковка отдельно не оплачивается — коробка, наполнитель и работа склада уже внутри тарифа за килограмм.',
  },
  {
  ...
  },
  {
    ...
    a: 'Нет. В чеке всегда указаны: цена товара, доставка (по тарифу за кг), страховка 2%, и комиссия за выкуп (10%, мин. 500 ₽; для опта с 1688 — от 3%), фото со склада. Упаковка входит в тариф, отдельной строкой её нет. Менеджер пришлёт смету до оплаты — без сюрпризов.',
  },
];
